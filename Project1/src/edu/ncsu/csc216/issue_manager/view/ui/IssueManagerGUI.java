...
public class IssueManagerGUI extends JFrame implements ActionListener {
	...
	private class NewPanel extends JPanel implements ActionListener {
		...
		public NewPanel() {
			...
			JScrollPane scrollNote = new JScrollPane(txtNote, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
	...
	private class IssueInfoPanel extends JPanel {
		...
		public IssueInfoPanel() {
			...
			JScrollPane summaryScrollPane = new JScrollPane(txtSummary, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
			JScrollPane notesScrollPane = new JScrollPane(txtNotes, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
